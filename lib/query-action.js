...
var getQueryActionRunner = function(sequelize){
  ...
  return {
    removeConstraint: async function(tableName,constraintName){
...
var queryActionTextComposer = {
  removeConstraint: function(tableName,constraintName){
    var template = "QueryActionRunner.removeConstraint(tableName, constraintName)";
